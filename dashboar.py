...
day_df = pd.read_csv("C:/Bangkit Academy/Tugas_Analisis_Data/Bike-sharing-dataset/day.csv")
day_df.head()
...
with st.sidebar:
    st.image("C:\Bangkit Academy\Tugas_Analisis_Data\Dashboard")
...
st.caption('Copyright (c) Abdul Djabar Nento 2024')